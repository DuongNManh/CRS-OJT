...
namespace ClaimRequest.API.Controllers
{
    ...
    public class EmailController : ControllerBase
    {
        ...
        public async Task<IActionResult> SendClaimReturnedEmail(Guid claimId, string template)
        {
            try
            {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> SendClaimSubmittedEmail(Guid claimId, string template)
        {
            try
            {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> SendManagerApprovedEmail(Guid claimId, string template)
        {
            try
            {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> SendClaimApprovedEmail(Guid claimId, string template)
        {
            try
            {
