...
export default function ForgotPassword({ setIsForgotPassword }: { setIsForgotPassword: (value: boolean) => void }) {
    ...
    return (
        <div className="w-full max-w-md p-8 rounded-xl shadow-2xl dark:bg-[#2f3136] dark:text-gray-50">
            ...
            <form onSubmit={isVerifyOtp ? handlePasswordReset : handleSendOtp} className="space-y-6">
                <div>
